export const leavesContent = {
  ...
  steps: [
    {
      ...
      screenshot: {
        src: "/screenshots/school/leaves-dashboard.png",
        alt: "Teacher Leaves Dashboard tab with Pending Requests, Approved This Month, LWP Days, and Active Leave Types cards",
        caption: 'The Dashboard\'s "Pending Approvals" section shows "All caught up!" when there are no outstanding requests.',
      },
    },
    {
      ...
      screenshot: {
        src: "/screenshots/school/leaves-how-it-works.png",
        alt: "Leave Management How it Works guide showing Module Overview page",
        caption: 'The guide describes Balance Tracking as monitoring how many days each teacher has used.',
      },
    },
    {
      ...
      screenshot: {
        src: "/screenshots/school/leaves-add-type-form.png",
        alt: "Add Leave Type form with Name Casual Leave, Code CL, Allocation 24 Yearly, and Paid Leave checked",
        caption: "This creates the default allocation new teachers get for this leave type — individual teachers can still be adjusted from the Balance tab.",
      },
    },
    {
      ...
      screenshot: {
        src: "/screenshots/school/leaves-types-grid.png",
        alt: "Leave Types tab showing seven leave type cards including Casual Leave, Earned Leave, and Sick Leave",
        caption: 'PAID types (e.g. Casual, Earned, Sick) count toward salary; UNPAID types (Leave Without Pay, Unpaid Leave) do not.',
      },
    },
    {
      title: "Edit or delete a leave type",
      description:
        'Click the pencil icon on a leave type card to open "Edit Leave Type" and update its Name, Code, Allocation, or Paid Leave status. Click the trash icon to delete it — a confirmation warns that teachers will no longer be able to select it once removed.',
      screenshot: {
        src: "/screenshots/school/leaves-edit-type-modal.png",
        alt: "Edit Leave Type modal for Casual Leave with Allocation changed to 12",
        caption: "Editing allocation here changes the default for new balances — it doesn't automatically retroactively adjust existing teacher balances.",
      },
    },
    {
      title: "Confirm before deleting a leave type",
      description:
        'The "Delete Leave Type?" dialog explicitly warns that teachers will no longer be able to select this type once deleted. Click "Delete" to confirm, or "Cancel" to back out.',
      screenshot: {
        src: "/screenshots/school/leaves-delete-type-confirm.png",
        alt: "Delete Leave Type confirmation dialog warning teachers will no longer be able to select it",
        caption: "This is irreversible — double-check no teachers currently rely on this leave type before deleting.",
      },
    },
    {
      ...
      screenshot: {
        src: "/screenshots/school/leaves-balance-table.png",
        alt: "Balance tab showing three teachers with per-leave-type day counts and total balance",
        caption: "Total Balance sums all leave type allocations for that teacher across the year.",
      },
    },
    {
      ...
      screenshot: {
        src: "/screenshots/school/leaves-manage-teacher-modal.png",
        alt: "Manage Teacher Leaves modal for Kamalpreet Sharma with per-type day inputs",
        caption: 'The modal explicitly notes: "Set 0 days to remove a leave type" for that individual teacher.',
      },
    },
    {
      ...
      screenshot: {
        src: "/screenshots/school/leaves-history-tab.png",
        alt: "History tab showing an empty table with a search teacher bar",
        caption: '"No records found" is expected until teachers begin submitting leave requests.',
      },
    },
  ],
  ...
  commonErrors: [
    ...
    {
      issue: "A teacher's leave balance looks wrong after editing the leave type",
  ...
  faqs: [
    {
      question: "What's the difference between editing a Leave Type and managing a teacher's Balance?",
      answer:
    ...
    {
      question: "Where can I see whether a specific leave request was approved or rejected?",
      answer:
